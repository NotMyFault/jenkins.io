...
* link:/projects/gsoc/2023/projects/alternative-jenkinsio-build-tool[Building Jenkins.io with alternative tools] with link:https://github.com/Vandit1604[Vandit Singh] as GSoC contributor.
* link:/projects/gsoc/2023/projects/docker-compose-build[Docker-based Jenkins quickstart examples] with link:https://github.com/ash-sxn[Ashutosh Saxena] as GSoC contributor.
